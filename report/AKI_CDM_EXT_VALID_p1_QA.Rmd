...
A Total of `r length(unique(dx_summ$key))` distinct CCS-grouped diagnosis has been assigned to patients before the encounter of interest. Figure 3 gives an overview of average history of patients' diagnosis prior to tne encounter of interest as well as the highly frequent historical diagnoses(e.g. `r dx_report$key[1]`(`r r dx_report$ccs_name[1]`); `r dx_report$key[2]`(`r r dx_report$ccs_name[2]`); `r dx_report$key[3]`(`r r dx_report$ccs_name[3]`); `r dx_report$key[4]`(`r r dx_report$ccs_name[4]`); `r dx_report$key[5]`(`r r dx_report$ccs_name[5]`); `r dx_report$key[6]`(`r r dx_report$ccs_name[6]`)).
