...
for(pred_task in pred_task_lst){
  ...
  saveRDS(rsample_idx,file=paste0("./data_local/data_preproc/",pred_in_d,"d_rsample_idx_",pred_task,"_co",carry_over,".rda"))
  saveRDS(var_by_yr,file=paste0("./data_local/data_preproc/",pred_in_d,"d_var_by_yr_",pred_task,"_co",carry_over,".rda"))
  saveRDS(var_bm,file=paste0("./data_local/data_preproc/",pred_in_d,"d_var_bm",pred_task,"_co",carry_over,".rda"))
